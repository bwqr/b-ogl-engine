#ifndef B_OGL_ENGINE_BEZIER_H
#define B_OGL_ENGINE_BEZIER_H
...
public:
    ...
    void setResolution(Extent2D res);

private:
    Extent2D resolution;

    std::vector<BezierMesh> meshes = {};
    ...
    constexpr static glm::vec3 teapot_cp[] = {
            // Dummy Control Point
            {0,       0,       0},
            // 1
            {1.4,     0.0,     2.4},
    ...
    constexpr static uint32_t teapot_cp_indices[PATCH_SIZE][ORDER + 1][ORDER + 1] = {
            // rim
